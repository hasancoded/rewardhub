      ...
      <div v-if="!isEditing" class="details-grid">
        <div class="detail-item">
          ...
          <div class="detail-value">
            <span class="monospace">{{ formatStudentId(profile._id) }}</span>
      ...
      <form v-else @submit.prevent="handleSubmit" class="edit-form">
        ...
        <div class="form-info">
          <p class="text-secondary">
            <strong>Note:</strong> Email, Student ID, Role, and Account Creation
...
// Format student ID (show first 8 and last 4 characters)
